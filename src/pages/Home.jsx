    ...
    <div className="max-w-7xl mx-auto px-4 py-12">
      <div className="bg-slate-900 border border-slate-800 p-8 rounded-[3rem] text-center space-y-8 relative overflow-hidden">
        ...
        <div className="flex flex-wrap items-center justify-center gap-6 pt-8">
          <Link to="/shop" className="bg-blue-600 hover:bg-blue-500 text-white px-10 py-5 rounded-2xl font-black text-lg transition-all shadow-xl shadow-blue-600/20 flex items-center gap-3 active:scale-95">
            <span>Xaridni boshlash</span>
            <ArrowRight className="w-6 h-6" />
          </Link>
          
          {user?.role === 'admin' && (
            <Link to="/admin" className="bg-slate-800 hover:bg-slate-700 text-white px-10 py-5 rounded-2xl font-black text-lg transition-all flex items-center gap-3 active:scale-95 border border-slate-700">
